...
@section('page_title'){{ "Add New Voice Note | ngVoices - Voters & Civic Education" }}@endsection
@section('content')
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Add Voice Note</li>
        </ol>
    </section>
    ...
    <section class="content container-fluid">
        ...
        <div class="box box-info">
            ...
            <!-- form start -->
            <form class="form-horizontal" method="POST" name="" action="{{ route('storeVoice') }}"
                enctype="multipart/form-data">
                @csrf
                @method('POST')
                <div class="box-body">
                    <h4 class="box-title">Add New Voice Note</h4>
                    @if (!blank($categories))
                    ...
                    <div class="row form-group">
                        <div class="col-xs-12 col-md-6">
                            ...
                            <input type="text" class="form-control" id="title" name="title" required
                                autocomplete="title" placeholder="Title of your voice note">
                        </div>
                        ...
                        <div class="col-xs-3 col-md-4">
                            ...
                            <input type="file" class="form-control" id="content" name="content" autocomplete="content"
                                placeholder="Voice Note" required>
                        </div>
