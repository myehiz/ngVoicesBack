...
<head>
    ...
    <title>Page not Found | NG Voices</title>
...
<body>
    ...
    <div class="md:flex"
        style="max-width: 1000px; max-height: 150px; position: absolute; top: 38%; left: 50%; margin-left: -350px; margin-top: 150px;">
        <div class="w-full md:w-1/2 flex items-center justify-center">
            ...
            <p class="text-grey-darker text-2xl md:text-3xl font-light mb-8 leading-normal">
                Sorry, the page you are looking does not exist or have been moved.</p>

            <a href="javascript:history.back(-1);">
                <button
                    class="bg-transparent text-black font-bold uppercase tracking-wide py-3 px-6 border-2 border-grey-light hover:border-grey rounded-lg">
                    Go Back
                </button>
            </a>
            &nbsp;&nbsp;
